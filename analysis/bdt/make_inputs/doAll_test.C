{
    ...
    gROOT->ProcessLine(".L ../../misc/class_files/v8.03/SS.cc+");
    gROOT->ProcessLine(".L ScanChain_test.C+");
    ...
    TString basedir_franny_2016 = "/nfs-7/userdata/fsetti/tupler_babies/merged/FT/v3.34_tthh/output/year_2016/";
    TString basedir_franny_2017 = "/nfs-7/userdata/fsetti/tupler_babies/merged/FT/v3.33_tthh/output/year_2017/";
    TString basedir_franny_2018 = "/nfs-7/userdata/fsetti/tupler_babies/merged/FT/v3.34_tthh/output/year_2018/";

    TString basedir_hmei_2016 = "/nfs-7/userdata/hmei/tupler_babies/merged/FT/v3.36_tthh/output/year_2016/";
    TString basedir_hmei_2017 = "/nfs-7/userdata/hmei/tupler_babies/merged/FT/v3.36_tthh/output/year_2017/";
    TString basedir_hmei_2018 = "/nfs-7/userdata/hmei/tupler_babies/merged/FT/v3.36_tthh/output/year_2018/";
    ...
    TChain *ch_ttHH = new TChain("t","ttHH");
    ch_ttHH->Add(basedir_hmei_2016+"/TTHHfilter.root");
    ch_ttHH->Add(basedir_hmei_2017+"/TTHHfilter.root");
    ch_ttHH->Add(basedir_hmei_2018+"/TTHHfilter.root");
    ScanChain(ch_ttHH, "", outputdir);
